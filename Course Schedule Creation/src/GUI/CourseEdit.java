...
public class CourseEdit extends JFrame {
	...
	public CourseEdit() {
		...
		btnSave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Course cou = new Course(textFieldCourseCode.getText(), textFieldCourseName.getText(),
						textFieldCourseDesc.getText(), textFieldCourseHrs.getText(), textFieldCourseCapacity.getText(),
						textFieldCoursePrereq.getText(), (String) fallComboBox.getSelectedItem(),
						(String) springComboBox.getSelectedItem(), (String) summerComboBox.getSelectedItem(),
	...
	class StudentTableModel extends AbstractTableModel {
		...
		public Object getValueAt(int rowIndex, int columnIndex) {
			...
			switch (columnIndex) {
			case 0:
				return student.getCourseCode();
			case 1:
				return student.getCourseName();
			case 2:
				return student.getCourseDescription();
			case 3:
				return student.getCourseHours();
			case 4:
				return student.getCourseCap();
			case 5:
				return student.getCourseOfferedInFall();
			case 6:
				return student.getCourseOfferedInSpring();
			case 7:
				return student.getCourseOfferedInSummer();
			case 8:
				return student.getCoursePrereqs();
			case 9:
				return student.getCourseTeachers();
	...
	public void readDataFromCSV() {
		...
		try {
			...
			while ((line = fileReader.readLine()) != null) {
				...
				String courseCode = "", courseName = "", courseDesc = "", courseHrs = "", courseCap = "",
						courseFall = "", courseSpring = "", courseSummer = "", coursePre = "", courseTeach = "";
				if (tokens.length > 0) {
					courseCode = tokens[0];
					courseName = tokens[1];
					courseDesc = tokens[2];
				...
				Course std = new Course(courseCode, courseName, courseDesc, courseHrs, courseCap, courseFall,
						courseSpring, courseSummer, coursePre, courseTeach);
				stdList.add(std);
			}
	...
	public void writeDataToCSV() {
		...
		try {
			...
			fileWriter.append(
					"courseCode,courseName,courseDesc,courseHrs,courseCap,courseFall,courseSpring,courseSummer,coursePre,courseTeach");
			fileWriter.append("\n");
